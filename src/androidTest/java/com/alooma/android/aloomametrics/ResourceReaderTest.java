...
public class ResourceReaderTest extends AndroidTestCase {
    ...
    private static final Class<?> RESOURCES_CLASS = com.alooma.android.aloomametrics.test_r_package.R.class;
    private static final int TEST_ID_ZERO = com.alooma.android.aloomametrics.test_r_package.R.id.TEST_ID_ZERO;
    private static final int TEST_DRAW_ZERO = com.alooma.android.aloomametrics.test_r_package.R.drawable.TEST_DRAW_ZERO;
}
