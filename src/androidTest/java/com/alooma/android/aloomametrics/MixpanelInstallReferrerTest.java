...
public class MixpanelInstallReferrerTest extends AndroidTestCase {
    public void setUp() {
        ...
        mIntent = new Intent();
        SharedPreferences prefs = getContext().getSharedPreferences(AConfig.REFERRER_PREFS_NAME, Context.MODE_PRIVATE);
    ...
    public void testNoReferrer() {
        ...
        SharedPreferences stored = getContext().getSharedPreferences(AConfig.REFERRER_PREFS_NAME, Context.MODE_PRIVATE);
