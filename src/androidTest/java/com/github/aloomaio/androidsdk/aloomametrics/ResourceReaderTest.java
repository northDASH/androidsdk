...
public class ResourceReaderTest extends AndroidTestCase {
    ...
    private static final String TEST_PACKAGE_NAME = "com.alooma.android.mpmetrics.test_r_package";
    private static final Class<?> RESOURCES_CLASS = com.github.aloomaio.androidsdk.aloomametrics.test_r_package.R.class;
    private static final int TEST_ID_ZERO = com.github.aloomaio.androidsdk.aloomametrics.test_r_package.R.id.TEST_ID_ZERO;
    private static final int TEST_DRAW_ZERO = com.github.aloomaio.androidsdk.aloomametrics.test_r_package.R.drawable.TEST_DRAW_ZERO;
}
