...
public abstract class ResourceReader implements ResourceIds {
        ...
        try {
            ...
            Log.i(LOGTAG,
                    "You may be missing a Resources class for your package due to your proguard configuration, " +
                            ...
                            "<meta-data android:name=\"com.alooma.android.AConfig.ResourcePackageName\" android:value=\"YOUR_PACKAGE_NAME\" />\n\n" +
    ...
    private static final String LOGTAG = "AloomaAPI.ResourceReader";
}
