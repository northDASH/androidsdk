...
public class InAppFragment extends Fragment {
    ...
    public void setDisplayState(final AloomaAPI mixpanel, final int stateId, final UpdateDisplayState.DisplayState.InAppNotificationState displayState) {
    ...
    private static final String LOGTAG = "AloomaAPI.InAppFragment";
