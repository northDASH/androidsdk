...
import com.alooma.android.aloomametrics.ResourceReader;
import com.alooma.android.aloomametrics.Tweaks;
import com.alooma.android.util.JSONUtils;
...
public class ViewCrawler implements UpdatesFromMixpanel, TrackingDebug {
    ...
    public ViewCrawler(Context context, String token, AloomaAPI mixpanel) {
        mConfig = AConfig.getInstance(context);
    ...
    private class ViewCrawlerHandler extends Handler {
        ...
        private void connectToEditor() {
            ...
            final String url = AConfig.getInstance(mContext).getEditorUrl() + mToken;
            try {
    ...
    private static final String SHARED_PREF_EDITS_FILE = "alooma.viewcrawler.changes";
    private static final String SHARED_PREF_CHANGES_KEY = "alooma.viewcrawler.changes";
    private static final String SHARED_PREF_BINDINGS_KEY = "alooma.viewcrawler.bindings";
    ...
    private static final String LOGTAG = "AloomaAPI.ViewCrawler";
}
