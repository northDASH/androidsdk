 ...
 *
 * - Calls AloomaAPI.track
 */
/* package */ class DynamicEventTracker implements ViewVisitor.OnEventListener {

    public DynamicEventTracker(AloomaAPI mixpanel, Handler homeHandler) {
        mMixpanel = mixpanel;
    ...
    private final AloomaAPI mMixpanel;
    ...
    private static String LOGTAG = "AloomaAPI.DynamicEventTracker";
}
